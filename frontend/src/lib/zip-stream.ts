...
/** biome-ignore-all lint/suspicious/noExplicitAny: Disabling typechecking for now since this was originally JavaScript */
/** biome-ignore-all lint/suspicious/noAssignInExpressions: Disabling typechecking for now since this was originally JavaScript */
/** biome-ignore-all lint/suspicious/noImplicitAnyLet: Disabling typechecking for now since this was originally JavaScript */
